...
def average_delivery_time2(): # <WHERE store_id == 0 AND line_item == 1> to fetch only online orders and only one line item (one row of data) for a particular order_number
    query = """
